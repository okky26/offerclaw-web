  ...
  return (
    <div className="w-full grid grid-flow-col auto-cols-max gap-4 overflow-scroll place-items-center lg:grid-cols-2 lg:grid-rows-2 lg:h-[728px] lg:gap-0 lg:gap-x-3 lg:place-items-stretch lg:overflow-hidden item">
      ...
      <Card
        cardComponent={{
            path : post[3].link,
            style : 'flex flex-col items-start justify-start gap-y-3 bg-white rounded-[16px] h-[318px] w-[215px] p-3 lg:w-[500px] lg:h-[255px] lg:p-4 lg:col-start-1 lg:row-start-2 lg:flex-row lg:mt-[110px] lg:gap-x-6',
            imgComponent : {
